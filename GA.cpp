...
int evaluation(struct population & x, int weight[], int profit[], int capacity, int num)
{
    ...
    {
        /* comment code segment is to randomly choose a object to drop
        int p = rand()%count;
...
int GA(ifstream& data)
{
   ...
   //generation
    ...
    for(int i = 0;i < MAX_POPULATION; i++)
    {
        ...
        // above random create a generation for a z-object backpack problem but the max amount of object is 32
        //cout << temp << endl;
